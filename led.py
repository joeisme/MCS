...
def establishCommandChannel():
    ...
    connectionAPI = 'https://api.mediatek.com/mcs/v2/devices/%(device_id)s/conn$
...
def waitAndExecuteCommand(commandChannel):
    while True:
        ...
        # command can be a response of heart beat or an update of the LED_contr$
